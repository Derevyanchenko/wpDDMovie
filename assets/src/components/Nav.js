...
const Nav = () => {
    ...
    const [ firstLoopArr, setFrstLoopArr ] = useState( true )

    function searchFromHandle( event ) {
    ...
    useEffect(() => {
        ...
        const searchRoute = `${ddMovie.resturl}ddmovie/v1/search?search=${searchTerm}`;
                        ...
                        <div className="md:ml-4 mt-3 md:mt-0">
                            <form action="#" className="search-form">
                                <div className="form-control">
                                    <input type="text" className="form-field ddMovie-search" onInput={searchFromHandle} placeholder="Search movie../" />
                                    { isDropdownOpen && searchResults && (
                                        <div className="searchMovies-dropdown">
